import { fromRomanNumeralsAndTonic, toRomanNumerals } from ".";

const $ = str => str.split(" ");

describe("tonal-progression", () => {
  test("concrete", () => {
    const inC = fromRomanNumeralsAndTonic("C");
    expect(inC($("I IIm7 V7"))).toEqual($("C Dm7 G7"));
    expect(inC($("Imaj7 2 IIIm7"))).toEqual(["Cmaj7", null, "Em7"]);
  ...
  test("abstract", () => {
    const roman = toRomanNumerals("C");
    expect(roman($("Cmaj7 Dm7 G7"))).toEqual(["Imaj7", "IIm7", "V7"]);
  });
});
